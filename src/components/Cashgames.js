    ...
    <>
      <PrizeContainer>
        <GrayContainer>
          <InstructionHeader>
            <OrangeDiv></OrangeDiv>
            <InstructionSpan>1₾ რეიკი = 1 ქულას</InstructionSpan>
          </InstructionHeader>
              ...
              .map((item) => {
                return (
                  <PlaceAmountPrizeContainer>
                    <PlaceNum>{item.rating}</PlaceNum>
                    <PrizeAmount>{item.prizeMoney} ₾</PrizeAmount>
          ...
          <BriefInfo>
            * ლიდერბორდის შედეგები განახლდება
            <br /> <PokerLobbie href="#">პოკერის ლობიში</PokerLobbie>
          </BriefInfo>
          <BriefInfoDesktop>
            * ლიდერბორდის შედეგები განახლდება{" "}
            <PokerLobbie href="#">პოკერის ლობიში</PokerLobbie>
          </BriefInfoDesktop>
        </GrayContainer>
      </PrizeContainer>
      <AdditionalInfo>
...
`;
const PrizeTitleDesktop = styled.span`
  display: none;
  @media (min-width: 1440px) {
    display: block;
    font-size: 13px;
